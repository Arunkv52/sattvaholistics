      ...
      <div className=" mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        <div className="lg:col-span-5">
          <div className="relative">
            ...
            <h2 className="text-4xl md:text-5xl xl:text-6xl font-light leading-tight tracking-tight text-neutral-900">
              Transforming experiences through{" "}
              <span className="font-semibold">
                mindfulness, clarity, and human connection.
              </span>
            </h2>

            <p className="mt-8 text-lg md:text-xl text-neutral-600 leading-relaxed max-w-xl">
              We create immersive wellness environments that help individuals
              reconnect with themselves through calm spaces, guided practices,
            ...
            <div className="relative overflow-hidden rounded-[2rem] shadow-2xl">
              ...
              <div className="absolute bottom-6 left-6 bg-white/90 backdrop-blur-md px-5 py-4 rounded-2xl shadow-lg max-w-xs">
                ...
                <h4 className="mt-1 text-lg font-semibold text-neutral-900">
                  Calm minds create stronger communities.
                </h4>
              </div>
            </div>
          </div>
