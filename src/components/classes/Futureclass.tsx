        ...
        <div className="relative z-10 flex h-full flex-col justify-between p-8 md:p-12">
          ...
          <div>
            <div className="flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between">
              {/* Left */}
              <div>
                <h1 className="flex flex-wrap items-center gap-3 text-4xl font-light uppercase tracking-tight text-white md:text-7xl">
                  <span>BALANCE</span>
                ...
                <p className="mt-6 max-w-sm md:text-sm text-base leading-relaxed text-white/80">
                  Discover yoga routines, classes, and tools tailored
                  for your journey, whether you're just starting or
